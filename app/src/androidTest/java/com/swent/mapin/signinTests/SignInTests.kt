...
class SignInScreenTest {
  ...
  fun signInScreen_appLogo_isDisplayed() {
    ...
    composeTestRule.onNodeWithContentDescription("App Logo").assertExists().assertIsDisplayed()
  }
  ...
  fun signInScreen_slogan_hasCorrectText() {
    ...
    composeTestRule.onNodeWithText("One Map. Every moment.").assertExists().assertIsDisplayed()
  }
  ...
  fun signInScreen_renderWithDifferentCallback_works() {
    composeTestRule.setContent {
      SignInScreen(viewModel = viewModel, onSignInSuccess = { /* Different callback */})
    }
