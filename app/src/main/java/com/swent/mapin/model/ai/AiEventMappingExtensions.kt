 ...
 * @param locationDescription Optional human-readable location description.
 *                            If not provided, uses the event's location name.
...
fun Event.toAiEventSummary(
  ...
  val capacityRemaining = capacity?.let { cap ->
 ...
 * @param locationDescriptionProvider Optional function that provides location description for each event
