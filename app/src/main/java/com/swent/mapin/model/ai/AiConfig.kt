...
object AiConfig {
   ...
   *
   * @param okHttpClient OkHttpClient instance (deprecated, kept for compatibility)
   * @param gson Gson instance for JSON serialization
   * @param baseUrl Backend URL (deprecated, kept for compatibility)
   * @return AiAssistantRepository implementation (fake or Firebase based on feature flag)
   */
  fun provideRepository(
    ...
    return if (AI_ASSISTANT_ENABLED) {
      FirebaseAiAssistantRepository(gson = gson)
    } else {
