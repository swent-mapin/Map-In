 ...
 *
 * This interface abstracts the AI recommendation service, allowing for different implementations
 * (e.g., real backend, fake for testing, etc.).
 */
interface AiAssistantRepository {
  /**
   * Requests event recommendations from the AI assistant.
   *
   * @param conversationId Optional conversation identifier for multi-turn conversations. Can be
   *   null for new conversations.
